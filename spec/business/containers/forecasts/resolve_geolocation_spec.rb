...
RSpec.describe Containers::Forecasts::ResolveGeolocation do
  ...
  it 'returns an existing geolocation without calling the APIs' do
    geolocation = create(:geolocation, zipcode:, latitude: 40.7357, longitude: -74.1724) # Create geolocation in the database
    geolocation_request = stub_geolocation_request(zipcode:, latitude: '40.7357', longitude: '-74.1724')
    geolocation_request_secondary = stub_geolocation_secondary_request(zipcode:, latitude: '40.7357', longitude: '-74.1724')
